...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <!-- CONTENT -->
    <h1 class="fw-bold">Daftar Anggota</h1>
    <!-- ENDCONTENT -->
        ...
        <div class="row">
            <div class="col">
                <div class="card border-0 h-100 text-decoration-none">
                    <img src="{{ asset('storage/' . $anggota->image)}}" alt="" width="300px">
                    <div class="card-body">
                        <h5 class="card-title">{{ $anggota->name }}</h5>
                        <p class="card-text">{{$anggota->jurusan}}</p>
